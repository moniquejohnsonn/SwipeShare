...
let mockGivers: [UserProfile] = [
    UserProfile(id: UUID().uuidString, name: "Alice", profilePictureURL: "", profilePicture: UIImage(contentsOfFile: "alice"), email: "alice@gmail.com", campus: "Columbia University in the City of New York", year: "Sophomore at Barnard College", major: "Psychology", numSwipes: 132, mealFrequency: "semesterly", mealCount: 10, isGiver: true, location: GeoPoint(latitude: 40.8057, longitude: -73.9621)),
    UserProfile(id: UUID().uuidString, name: "Joe", profilePictureURL: "", profilePicture: UIImage(contentsOfFile: "joe"), email: "joe@gmail.com", campus: "Columbia University in the City of New York", year: "Freshman at Columbia College", major: "Neuroscience", numSwipes: 19, mealFrequency: "weekly", mealCount: 4, isGiver: true, location: GeoPoint(latitude: 40.8059, longitude: -73.9625)),
    UserProfile(id: UUID().uuidString, name: "Bob", profilePictureURL: "", profilePicture: UIImage(contentsOfFile: "bob"), email: "bob@gmail.com", campus: "Columbia University in the City of New York", year: "Senior at Columbia College", major: "Mathematics", numSwipes: 87, mealFrequency: "semesterly", mealCount: 21, isGiver: true, location: GeoPoint(latitude: 40.8068, longitude: -73.9638))
]

// mock receivers
let mockReceivers: [UserProfile] = [
    UserProfile(id: UUID().uuidString, name: "Jon", profilePictureURL: "", profilePicture: UIImage(contentsOfFile: "joe"), email: "jon@gmail.com", campus: "Columbia University in the City of New York", year: "Senior at Columbia Engineering", major: "Computer Science", numSwipes: 0, mealFrequency: "", mealCount: 0, isGiver: false, location: GeoPoint(latitude: 40.8057, longitude: -73.9621)),
    UserProfile(id: UUID().uuidString, name: "Lily", profilePictureURL: "", profilePicture: UIImage(contentsOfFile: "alice"), email: "lily@gmail.com", campus: "Columbia University in the City of New York", year: "Junior at the School of General Studies", major: "Human Rights", numSwipes: 0, mealFrequency: "", mealCount: 0, isGiver: false, location: GeoPoint(latitude: 40.8057, longitude: -73.9621)),
    UserProfile(id: UUID().uuidString, name: "Sam", profilePictureURL: "", profilePicture: UIImage(contentsOfFile: "bob"), email: "sam@gmail.com", campus: "Columbia University in the City of New York", year: "Sophomore at Columbia College", major: "Biology", numSwipes: 0, mealFrequency: "", mealCount: 0, isGiver: false, location: GeoPoint(latitude: 40.8057, longitude: -73.9621)),
]
